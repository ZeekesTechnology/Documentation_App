...
type SortField = "name" | "issuedBy" | "expires" | "updated" | "notes";
...
export function SslTrackerPage() {
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-start justify-between gap-4">
        <h1 className="text-xl font-semibold text-white">SSL Certificates</h1>
                ...
                <td colSpan={7} className="px-3 py-16">
                  <div className="flex flex-col items-center justify-center text-center">
                    <Inbox
                      ...
                      strokeWidth={1.25}
                    />
                    <p className="text-sm text-gray-400">No SSL Certificates</p>
                  </div>
                </td>
              </tr>
            </tbody>
