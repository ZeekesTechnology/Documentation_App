...
type SortField = "name" | "product" | "vendor" | "expiration" | "seats";
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-start justify-between gap-4">
        <h1 className="text-xl font-semibold text-white">Licensing</h1>
                ...
                <td colSpan={7} className="px-3 py-16">
                  <div className="flex flex-col items-center justify-center text-center">
                    <Inbox
                      ...
                      strokeWidth={1.25}
                    />
                    <p className="text-sm text-gray-400">No Licensing</p>
                  </div>
                </td>
              </tr>
            </tbody>
